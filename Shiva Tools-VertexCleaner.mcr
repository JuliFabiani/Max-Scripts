macroScript VertexCleaner category:"Shiva Tools" tooltip:"Vertex Cleaner"
(

-- Vertex Cleaner 1.0 by Yegor Tsyba --
...
if  vx_2edges.count > 0 do (
			...
			for i = 1 to vx_2edges.count do	(	
			 print ( trash_val / 15.708 )
				if vx_weight[i] <= ( trash_val * 0.01573 ) then append vx_selected vx_2edges[i]		
				)	--end of FOR i
